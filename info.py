...
BOT_TOKEN = environ.get('BOT_TOKEN', '7143703576:AAH_NciEslycjk0HFPavQJg4i0iPUrFs-zQ')
...
QR_CODE = environ.get('QR_CODE', 'https://telegra.ph/file/8f00edaf1081a8b97a2a6.jpg')
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7462351545').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/MoggerKing")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002196614393'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/JTestinGrp')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002200587837').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "publicdbz")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002196614393'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002196614393'))
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_to")
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002196614393'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002196614393'))
